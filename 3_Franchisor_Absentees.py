...
print("========== STEP 3: Process Franchisor Absentees OAS data ==========")
...
PendingConversion.to_excel("Pending_Conversion_Franchisor_ABS" + extension, index=False)
print("CREATE: Pending_Conversion_Franchisor_ABS" + extension)

OutstandingScans.to_excel("Outstanding_Scans_Franchisor_ABS" + extension, index=False)
print("CREATE: Outstanding_Scans_Franchisor_ABS" + extension)

ScannedOAS.to_excel("Scanned_OAS_Franchisor_ABS" + extension, index=False)
print("CREATE: Scanned_OAS_Franchisor_ABS" + extension)

ConvertedOAS.to_excel("Converted_OAS_Franchisor_ABS" + extension, index=False)
print("CREATE: Converted_OAS_Franchisor_ABS" + extension)